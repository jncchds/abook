...
- **Story Bible, Characters & Plot Threads** — automatically generated by the Planner agent (4-phase: Story Bible → Characters → Plot Threads → Chapter Outlines); each phase tracks a **Complete / Not Started** status, is fully editable, and can be individually completed, reopened, or cleared
