...
public class ContinuityCheckerAgent : AgentBase
{
    ...
    public async Task PreWriteCheckAndFixAsync(int bookId, int chapterId, CancellationToken ct = default)
    {
        ...
        var detectMessages = new List<Microsoft.Extensions.AI.ChatMessage>();
        detectMessages.Add(new Microsoft.Extensions.AI.ChatMessage(Microsoft.Extensions.AI.ChatRole.System, $"""
            ...
            """));
        detectMessages.Add(new Microsoft.Extensions.AI.ChatMessage(Microsoft.Extensions.AI.ChatRole.User, $"""
            ## Established Facts
            {establishedFacts}
        ...
        var detectResponse = await StreamResponseAsync(config, detectMessages, bookId, chapterId, AgentRole.ContinuityChecker, ct);
        ...
        var fixMessages = new List<Microsoft.Extensions.AI.ChatMessage>();
        fixMessages.Add(new Microsoft.Extensions.AI.ChatMessage(Microsoft.Extensions.AI.ChatRole.System, $"""
            ...
            """));
        fixMessages.Add(new Microsoft.Extensions.AI.ChatMessage(Microsoft.Extensions.AI.ChatRole.User, $"""
            ## Established Facts
            {establishedFacts}
        ...
        var fixedOutline = await StreamResponseAsync(config, fixMessages, bookId, chapterId, AgentRole.ContinuityChecker, ct);
    ...
    public async Task<CheckerResult> CheckAsync(int bookId, int? chapterId = null, CancellationToken ct = default, string? humanNotes = null)
    {
        ...
        var responseJson = await StreamResponseAsync(config, messages, bookId, (int?)null, AgentRole.ContinuityChecker, ct,
