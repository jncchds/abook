...
public enum AgentRole { Planner, Writer, Editor, ContinuityChecker, Embedder, StoryBibleAgent, CharactersAgent, PlotThreadsAgent, ChaptersAgent, WorkflowStep = 99 }

public enum MessageType { Content, Question, Answer, SystemNote, Feedback }

public enum LlmProvider { Ollama, OpenAI, OpenAICompatible, GoogleAIStudio }
