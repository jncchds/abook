...
export default function ChapterView() {
  ...
  // Exclude ContinuityChecker — its output is structural analysis, not chapter content.
  const activeRole = runStatus?.chapterId === chapter?.id && runStatus?.role !== 'ContinuityChecker'
    ? runStatus?.role
    : undefined
